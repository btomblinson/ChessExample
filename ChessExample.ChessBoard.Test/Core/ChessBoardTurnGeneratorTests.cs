...
namespace ChessExample.ChessBoard.Test.Core
{
    ...
    public class ChessBoardTurnGeneratorTests
    {
        ...
        public void WhiteKnightGenerateMovesStartOfGame()
        {
            ...
            ChessBoardSpace space = new ChessBoardSpace(1, 0, new ChessPiece.Core.ChessPiece(ChessPieceType.Knight, ChessPieceColor.White));

            Assert.That(ChessBoardTurnGenerator.KnightGenerator(board, space).Count, Is.EqualTo(2), "Invalid generated moves.");

            space = new ChessBoardSpace(6, 0, new ChessPiece.Core.ChessPiece(ChessPieceType.Knight, ChessPieceColor.White));
        ...
        {
            ChessBoard board = new();
           ChessBoardSpace space = new ChessBoardSpace(0, 0, new ChessPiece.Core.ChessPiece(ChessPieceType.Rook, ChessPieceColor.White));

            Assert.That(ChessBoardTurnGenerator.RookGenerator(board, space).Count, Is.EqualTo(0), "Invalid generated moves.");

            space = new ChessBoardSpace(7, 0, new ChessPiece.Core.ChessPiece(ChessPieceType.Rook, ChessPieceColor.White));
